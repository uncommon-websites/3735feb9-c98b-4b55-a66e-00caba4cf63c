...
<script lang="ts">
  ...
  name: "Jamie Chen",
  role: "Founder, Kortix-ai",
  image: "/generated/image-a-friendly-founder-in-a-modern-workspace.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We built Suna because we were drowning in repetitive digital tasks—so we made the open, autonomous agent we wished we had."`}
      />
